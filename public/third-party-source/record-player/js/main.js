...
;(function(window) {
	...
	function loadTurntableAssets(callback) {
		new AbbeyLoad([{
			'room1' : 'third-party-source/record-player/mp3/room1.mp3',
			'room2' : 'third-party-source/record-player/mp3/room2.mp3',
			'room3' : 'third-party-source/record-player/mp3/room3.mp3',
			'noise' : 'third-party-source/record-player/mp3/noise1.mp3'
		}], function(bufferList) {
			if( typeof callback === 'function' ) {
				callback(bufferList);
			}
